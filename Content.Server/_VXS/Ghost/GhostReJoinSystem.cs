...
using Content.Shared._VXS.CCVar;
using Content.Shared._VXS.Ghost;
...
namespace Content.Server._VXS.Ghost;
...
public sealed class GhostReJoinSystem : SharedGhostReJoinSystem
{
    ...
    public override void Initialize()
    {
        ...
        _console.RegisterCommand("newLifeLobby", ReturnToRoundCommand, ReturnToRoundCompletion);
    }
